function [t1, J1, t2, J2, t3, J3, profile, delta_s] = StopTrajGen(a0, v0, d, J, plot_traj)
...
if v0 < v_star
    ...
    v1 = v0 + (a0 + d)*t1/2;
    v2 = v1 + t2*d;
    delta_s = gama(J1, a0, v0, t1) + gama(J2, d, v1, t2) + gama(J3, d, v2, t3);
elseif v0 < a0pow2_2J;
...
if plot_traj
    ...
    for i = 2:n
        ...
        st(i) = int_tustin(vt(i), vt(i-1), st(i-1), dt);
    end
